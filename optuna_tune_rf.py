...
def load_and_prepare_data():
    ...
    try:
        tc_external = pd.read_csv('data/raw/train_supplement/Tc_SMILES.csv')
    ...
    try:
        tg_external = pd.read_csv('data/raw/train_supplement/Tg_SMILES_class_pid_polyinfo_median.csv')
        train_smiles = set(train_df['SMILES'])
